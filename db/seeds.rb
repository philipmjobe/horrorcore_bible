...
Artist.create!(name: "Necro", years_active: "2009-present", bio: " Ron Raphael Braunstein (born June 7, 1976), better known by his stage-name Necro, is an American rapper from Brooklyn. He is the owner of Psycho+Logical-Records founded November 1999. He is the younger brother of rapper Ill Bill.
...
Artist.create!(name: "Słoń", years_active: "2009-present", bio: "Słoń is a Polish rapper from Poznań who represents the horrorcore trend. It is the most famous representative of this subspecies in Poland. He leads a solo career and co-creates the composition of WSRH and Demonologia (Słoń & Mikser).
...
Artist.create!(name: "AkVoN", years_active: "2011", bio: "AkVoN was a rap group comprised of Psycho Jesus, F.E.T.U.S., and Lyrikal. Their self-titled debut album was released on the nationwide “Gospel of the Grave Tour” with co-Headliner Mars in July 2011.", image: "https://horrorcorewiki.com/wp-content/uploads/2020/02/akvon.jpg")
Artist.create!(name: "Alcoholic Monsterz", years_active: "2005", bio: "(Alcoholic) OH YES! (MonsterZ) The meaning of it is not about when you were 4 years old asking mommy to shut the closet door the monsterz might get you. The word Monsterz could be used for lots of things. Last night he ripped out your best friends girl a new asshole now your upset, or he drinks the piss end of the bottle even when there's a cigarette soaking at the bottem. Kicking open up the stairs neighbors door throwing there kids sneakers out in the street screaming your gonna kill them wile garbage cans are throwen through there windows WINK! WINK! There isent too much thats gotta be said 3 Goons by the names of… Kardiac/Doc.Mangler/Many Faces. All with drinking problems with nothing to Prove but getting smacked in the face with a bottle can start off todays song. 12 steps to the bottom Drink Drive and die intoxicated", image: "https://f4.bcbits.com/img/a0767834877_10.jpg")
Artist.create!(name: "Alias Grim", years_active: "2014", bio: "Alias Grim combined two of the most talented, yet demented artists within it's realm, KGP and Bloodshot. HorrorCrunk!", image: "https://artist.radioairplay.com/airplay_pictures/pictures/000/482/158/e6d6fd8836f256b3ba30c8e812aaca83_lg.jpg")
Artist.create!(name: "Alla Xul Elu", years_active: "2015-present", bio: "In the furthest reaches of the void, an ancient evil has awakened. This demonic force has risen with one intent: to usher in an age of darkness. It’s craving for the end of all life has manifested itself in the form of three. This ghastly trinity walks the mortal realm as Billy Obey, Joe Black and Lee Carver. The Almighty Alla Xul Elu.
...
Artist.create!(name: "Araknidd", years_active: "2018-present", bio: "Hailing from Ontario Canada, Araknidd started in professional music at the early age of 16. After having being trained musically for many years it was a very smooth transition.
...
Artist.create!(name: "Babble the Demon", years_active: "2021-present", bio: "Babble the Demon is a Meztisa-American singer, song writer, producer, and artist from Austin, Texas. She is recognized for her large range in genre and style, covering trap-metal, horrorcore, rap, and RnB. The combination of these birthed a new genre called DieSoul (HorrorCore Trap RnB).
...
Artist.create!(name: "Bake Lo", years_active: "2015-2019", bio: "Charles baker (born on march 1st, 1994), better known by his stage name Bake Lo, has been quoted to be one of the hardest working artists around. Not only because of the immense energy that he brings to the stage and microphone, but also because of what he does behind the scenes. He has a willingness to work that leave some intimidated. This artist comes hardcore with an intricate but clear way of rhyming with his very own, unique style of music. Growing up in the small but mighty city of Ecorse, MI wasn't always easy. Other than being located on the outskirts of Detroit, the city was riddled with problems.
...
Artist.create!(name: "Bedlam", years_active: "199-2015", bio: "Bedlam are a seminal Detroit-area horrorcore rap group from the mid-Michigan city of Saginaw.
